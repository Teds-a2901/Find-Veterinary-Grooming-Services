...
include_once 'includes/outputvetandgroomcategories.inc.php';

$category_categories = $_GET['categories'];
$category_data = getCategoryActive("categories", $category_categories);
...
<html>
  ...
  <!-----MAIN CONTAINER-------->
                        <div class = "main-container">
                            <h2> <?php echo $category_categories  ?> Categories </h2>
                                <!-----SEARCH BOX------>
                    ...
                    <div class = "posts-collect" id="output2">
                                <div class = "posts-main-container">  
                                    <?php
                                        ...
                                        $rating = new Rating();
                                        $categories=getProdByCategory($cid);
                                                ...
                                                ?>
                                                    ...
                                                    <div class = "all <?php echo $item['b_service_provide'] ?>"> 
                                                        <div class = "post-content">
                                                            ...
                                                            <span class = "category-name"><?php echo $item['b_service_provide'] ?></span>
