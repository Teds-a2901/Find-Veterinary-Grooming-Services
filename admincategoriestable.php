            ...
            <div class="table-data">
				<div class="order">
					...
					<table>
						...
						<tbody id="output1">
						<?php 
						$sqltt = mysqli_query($conn, "SELECT * FROM categories");
						$count=1;
						$value = mysqli_num_rows($sqltt);
						if($value > 0){
							while($value = mysqli_fetch_array($sqltt)){
						?>	
							<tr>
								<td><?php echo $count;?></td>
								<td>
									<img <?php echo '<img src="vetphoto/'.$value['cat_img'].'"'; ?>>
									<td><?php echo $value ['cat_name'];?></td>
								</td>
								<td><span class="status completed"><a href="updatedeletecategories.php?cat_ID=<?php echo htmlentities ($value['cat_ID'])?>" class="edit">Edit</a></span></td>
								<td><span class="status pending"><a href="admincategoriestable.php?delcat=<?php echo $value['cat_ID']?>" onClick="return confirm('Do you really want to remove this record?');" class="delete">Delete</a></span></td>
							</tr>
						<?php 
						$count = $count+1;
					}}?>
